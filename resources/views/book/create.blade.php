...
@section('content')
    ...
    <form action="/book" method="post">
        ...
        <input type="text" name="title"style="height: 32px;width: 150px;background-color: darkgray;border: 1px solid black; border-radius: 13px" value="{{old('title')}}">
        ...
        <input type="text"name="publish_year"style="height: 32px;width: 150px;background-color: darkgray;border: 1px solid black; border-radius: 13px" value="{{old('publish_year')}}">
        <p style="font-family: 'Sitka Subheading';font-size: 25px">Write anything about book</p>
        <textarea name="description"style="background-color: darkgrey;border: 1px solid black">
            {{old('description')}}
        </textarea>
